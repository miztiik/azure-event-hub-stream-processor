...
var event_consumer_group_name = replace('${eventHubParams.eventHubNamePrefix}-consumers-${deploymentParams.global_uniqueness}', '_', '-')


resource r_event_consumer_group 'Microsoft.EventHub/namespaces/eventhubs/consumergroups@2021-06-01-preview' = {
  parent: r_event_hub
  name: event_consumer_group_name
}
...
output event_hub_consumer_group_name string = r_event_consumer_group.name
